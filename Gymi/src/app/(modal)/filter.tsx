...
const Filter = () => {
  ...
  const scale = useSharedValue(0);  // create a shared value, which is a special kind of state that can be used in animations. 
  ...
  useEffect(() => {
    ...
    if (hasSelected !== newSelected) {  // If the selected is changed
